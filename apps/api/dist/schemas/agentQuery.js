...
exports.AgentQuerySchema = zod_1.z.object({
    ...
    error: zod_1.z.object({
        ...
        type: zod_1.z.union([exports.ErrorTypeEnum, zod_1.z.string()]).default('process_exit'),
        exit_code: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).nullable().optional(),
    ...
    environment: zod_1.z.object({
        os: zod_1.z.object({
            family: zod_1.z.string().default('linux'),
            distro: zod_1.z.string().optional(),
            version: zod_1.z.string().optional(),
            arch: zod_1.z.string().optional(),
            libc: zod_1.z.string().nullable().optional(),
        }).passthrough().optional(),
        runtime: zod_1.z.object({ name: zod_1.z.string(), version: zod_1.z.string() }).passthrough().optional(),
        shell: zod_1.z.object({ name: zod_1.z.string() }).passthrough().optional(),
        container: zod_1.z.object({ image: zod_1.z.string(), runtime: zod_1.z.string() }).passthrough().optional(),
        ci: zod_1.z.object({ provider: zod_1.z.string(), runner: zod_1.z.string() }).passthrough().optional(),
    ...
    agent: zod_1.z.union([
        zod_1.z.object({
            id: zod_1.z.string(),
            retry_count: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).optional(),
            urgency: exports.UrgencyEnum.optional().default('standard'),
            bounty: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).nullable().optional(),
        }).passthrough(),
        zod_1.z.string().transform(s => ({ id: s })),
        zod_1.z.number().transform(n => ({ id: String(n) })),
    ]),
});
